...
export class EditableTableMobile extends HTMLElement {
        ...
        const updateRowContent = () => {
            if (isEditing) {
                tr.innerHTML = `
                    ...
                    <td><app-btn variant="icon" class="save-btn" title="i18n:[save_entry_title]">💾</app-btn></td>
                `;
                ...
                tr.innerHTML = `
                    ...
                    <td>
                        <div class="actions-td">
                            <app-btn class="edit-btn" variant="icon" title="i18n:[save_change_title]">✏️</app-btn>
                            <app-btn class="del-btn" variant="icon" title="i18n:[save_delete_title]">🗑️</app-btn>
                        </div>
                    </td>                    
                `;
...
customElements.define('app-editable-table-mobile', EditableTableMobile);